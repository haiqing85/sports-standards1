...
KEYWORDS = [
    ...
    "飞盘", "滑板", "攀岩", "轮滑", "钓鱼", "拔河",
    # ── 拼装运动地板专项（新增）──
    "悬浮式拼装地板", "悬浮拼装地板", "拼装运动地板", "悬浮地板", "悬浮式地板",
    "拼装地板", "拼装式地板", "运动拼装地板",
    # ── 体育建设其他专项（新增）──
    "运动场跑道", "橡胶地板", "运动橡胶地板", "橡胶卷材", "橡胶地砖",
    "人造冰场", "制冰", "冰场", "溜冰场",
    "攀爬架", "攀爬墙", "攀岩墙", "体育攀岩",
    "体育场看台", "看台座椅", "运动场座椅",
    "泳池", "游泳池水", "泳道", "水上运动",
...
SPORTS_TERMS = [
    ...
    # 补全 KEYWORDS 中存在但原先遗漏的词
    "赛艇","皮划艇","帆船","帆板","铁人三项","现代五项","花样游泳","跳水","跳高","跳远","跑步",
    "体育建筑","学校体育","学校操场","室外健身","公共健身","运动木地板","体育木地板",
    "田径场","游泳场","体育场馆照明","体育建筑电气","草坪填充","颗粒填充","橡胶面层运动场",
    # SACTC 体育行业标准专项补充
    "体育赛事","群众体育","运动护具","护具","擂击","运动营地","自驾运动",
    "低氧训练","低氧呼吸","体育运动","运动器材","运动装备","体育装备","运动场地照明",
    # ── 拼装运动地板专项（新增）──
    "悬浮式拼装地板","悬浮拼装地板","拼装运动地板","悬浮地板","悬浮式地板",
    "拼装地板","拼装式地板","运动拼装地板",
    # ── 体育建设其他专项（新增）──
    "橡胶地板","运动橡胶地板","橡胶卷材","运动场跑道",
    "冰场","溜冰场","人造冰场","冰雪运动",
    "攀爬架","攀爬墙","攀岩墙",
    "泳池","泳道","水上运动",
    "运动地面","体育地板","运动场地面",
