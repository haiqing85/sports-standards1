// 路径：functions/api/github-proxy/[[path]].js
// 通配符路由，匹配 /api/github-proxy/* 所有子路径
// 将请求代理到 GitHub API，Token 从 EdgeOne 环境变量读取
...
export async function onRequest(context) {
  ...
  // /api/github-proxy/repos/xxx/yyy  →  /repos/xxx/yyy
